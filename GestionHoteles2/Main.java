...
public class Main {
    public static void main(String[] args) {
        ...
        Hotel hotel6 = new Hotel("Hotel Macarena", 333, new String[]{"Individual", "Doble", "Triple", "Cuádruple"}, new double[]{50.0, 80.0, 110.0, 140.0});
        // Creo habitaciones para el hotel6
        hotel6.addHabitacion(new Habitacion("Individual", 50.0, true));
        hotel6.addHabitacion(new Habitacion("Doble", 80.0, true));
        hotel6.addHabitacion(new Habitacion("Triple", 110.0, true));
        hotel6.addHabitacion(new Habitacion("Cuádruple", 140.0, true));
